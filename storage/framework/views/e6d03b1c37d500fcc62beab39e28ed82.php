...
<div class="container">
    ...
    <div class="content">
        <h2><?php echo e($comment->user->name); ?> has commented on your post:</h2>
        <p>Your post titled "<strong><?php echo e($comment->commentable->title); ?></strong>" has received a new comment:</p>
